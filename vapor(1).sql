...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 24, 2023 at 11:26 PM
...
(3, 'Pod caliburn', 2, 89, 500000, '1689926583_c344c855ebac758f284e.png');
...
INSERT INTO `transaksi` (`id_transaksi`, `id_pembayaran`, `id_user`, `tgl`, `keterangan`) VALUES
(6, 2, 2, '2023-07-23', 'Membeli 2'),
(7, 0, 0, '2023-07-23', ''),
(8, 2, 1, '2023-07-24', 'beli');
...
INSERT INTO `user` (`id_user`, `nama`, `username`, `tlp`, `password`, `role`) VALUES
